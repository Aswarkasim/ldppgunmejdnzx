...
class AdminKelasController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($cari) {
            $kelas = Kelas::where('name', 'like', '%' . $cari . '%')->wherePeriodeId($periode_id)->orderBy('name', 'asc')->paginate(10);
        } else {
            $kelas = Kelas::orderBy('name', 'asc')->wherePeriodeId($periode_id)->paginate(10);
        }
        $data = [
            'title'   => 'Kelas',
